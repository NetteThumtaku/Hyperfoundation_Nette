// Select the elements
const homeimgSection = document.querySelector('.monument6'); // The section to track mouse movement
const customCursor = document.querySelector('.cursor7'); // The custom cursor element
...
homeimgSection.addEventListener('mousemove', (e) => {
    ...
    function setHeight() {
    const monument = document.querySelector('.monument6');
