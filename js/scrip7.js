// Select the elements
const homeimgSection = document.querySelector('.monument7'); // The section to track mouse movement
const customCursor = document.querySelector('.cursor8'); // The custom cursor element
...
homeimgSection.addEventListener('mousemove', (e) => {
    ...
    function setHeight() {
    const monument = document.querySelector('.monument7');
