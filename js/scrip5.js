// Select the elements
const homeimgSection = document.querySelector('.monument5'); // The section to track mouse movement
const customCursor = document.querySelector('.cursor6'); // The custom cursor element
...
homeimgSection.addEventListener('mousemove', (e) => {
    ...
    function setHeight() {
    const monument = document.querySelector('.monument5');
